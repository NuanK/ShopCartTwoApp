package com.bwie.shopcarttwo.adapter;
...
import com.bwie.shopcarttwo.MainActivity;
import com.bwie.shopcarttwo.R;
import com.bwie.shopcarttwo.bean.GoodsBean;
import com.bwie.shopcarttwo.bean.GroupBean;
import com.bwie.shopcarttwo.view.AddDeleteView;
...
public class MyShopAdapter  extends BaseExpandableListAdapter {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        yprice.setText(goods.get(groupPosition).get(childPosition).getPrice() + "");
